# <h1 align="center">🧱 Resumo do Lab: Construindo Arquiteturas no Microsoft Azure AZ-900</h1>
Este repositório reúne os principais aprendizados adquiridos durante o curso **Componentes de Arquiteturas no Azure** da plataforma [DIO.me](https://web.dio.me), Arquitetura e Serviços Azure - Módulo 2. O foco está nos benefícios e aplicações práticas da plataforma Microsoft Azure, explorando seus recursos e funcionalidades.
